...
public class HomeActivity extends AppCompatActivity {
    ...
    private void addTask(){
        ...
        mDisplayDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(HomeActivity.this,android.R.style.Theme_Holo_Dialog_MinWidth,mDateSetListener,year,month,day);
                    ...
                    reference.child(id).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(HomeActivity.this,"Fail: "+error,Toast.LENGTH_LONG).show();
                                loader.dismiss();
                            }
                        }
                    });
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child(key).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(HomeActivity.this,"Data has been updated successfully!",Toast.LENGTH_LONG).show();
                        }else{
                            String err=task.getException().toString();
                            Toast.makeText(HomeActivity.this,"Updated failed!-",Toast.LENGTH_LONG).show();
        ...
        delButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(HomeActivity.this,"Task has been deleted successfully",Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(HomeActivity.this,"Deleted has been failed!",Toast.LENGTH_LONG).show();
                        }
                    }
                });
                dialog.dismiss();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        switch (item.getItemId()){
            ...
            break;
            case R.id.profile:{
                Intent intent=new Intent(HomeActivity.this,dashboardhome.class);
                startActivity(intent);
            }
            break;
            case R.id.task: {
