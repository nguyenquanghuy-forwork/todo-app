    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            if (connected){
                ...
                Toast.makeText(LoginScreen.this,"- Please Check Your Internet Access -",Toast.LENGTH_LONG).show();
            }
            ...
            mRecoverPassTv.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    androidx.appcompat.app.AlertDialog.Builder myDialog = new androidx.appcompat.app.AlertDialog.Builder(LoginScreen.this);
                    LayoutInflater inflater = LayoutInflater.from(LoginScreen.this);
                            ...
                            mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(LoginScreen.this, "- Please Check Your Email -", Toast.LENGTH_LONG).show();
                                        dialog.dismiss();
                                        loader.dismiss();
                                    } else {
                                        Toast.makeText(LoginScreen.this, "- Your Email Wrong -", Toast.LENGTH_LONG).show();
                                        loader.dismiss();
                                    }
                                }
                        ...
                        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(LoginScreen.this, "Login Failed! User Name or Password Uncorrect!", Toast.LENGTH_LONG).show();
                                    loader.dismiss();
                                }
                            }
                        });
